...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<table id="dataList"
							...
							<tbody>
								...
								<tr>
									...
									<td>${o.orderDesc }</td>
									<td>
									<c:if test="${o.payType==0 }">支付宝</c:if>
									<c:if test="${o.payType==1 }">微信</c:if>
									<c:if test="${o.payType==2 }">其他</c:if>
									
									</td>
									<td>${o.orderStatus==1?'已支付':'未支付' }</td>
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							...
							<select id="selectPageSize" class="form-control" onchange="javaScript:toPage(${pageInfo.pageNum });">
	...
	<script>
		...
		function toPage(pageNum){
			//获取pageSize值 是select标签选中的值
			var select = document.getElementById("selectPageSize");
			//获取select的值
